...
def simulation_parameters():
    ...
    results_path = '//10.12.70.26/B12TProjArchive/Projects/CORRUG DEMO/HE11-Launcher'
    var_range = {}

    var_range['version_num'] = ['A0068-PT2003']    # version number
    var_range['Frequency'] = [95,90,92,93,94,95,96,98,100]
    ...
    var_list = [['CWG Straight Section Length', 'TE11 HE11 Conv Profile', 'Frequency'],['CWG Straight Section Length', 'CWG Uptaper Profile', 'Frequency'],['TE11 HE11 Conv Profile', 'CWG Uptaper Profile', 'Frequency']]
